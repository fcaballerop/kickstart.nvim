...
-- Harpoon keymaps
vim.keymap.set('n', '<leader>Hq', require('harpoon.ui').toggle_quick_menu, { desc = 'Harpoon [q]uick menu' })
vim.keymap.set('n', '<leader>Ha', require('harpoon.mark').add_file, { desc = '[A]dd file' })
